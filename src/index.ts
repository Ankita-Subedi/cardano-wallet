...
import { getWallet, initWallet } from "./wallet";
...
async function main() {
  ...
  rl.question("Enter your mnemonic phrase: ", async (inputMnemonic) => {
    try {
      await initWallet(inputMnemonic);
